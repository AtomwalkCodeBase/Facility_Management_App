...
import { View, Text, Modal, ActivityIndicator, Image, TouchableOpacity, Dimensions, StyleSheet } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  modalContainer: {
    ...
    alignItems: 'center',
    justifyContent: 'center',
    // Removed top and left positioning to center the modal
    shadowColor: '#000',
